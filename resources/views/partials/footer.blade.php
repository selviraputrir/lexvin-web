<footer class="bg-gradient-to-b from-[#441425] to-[#2B0C1F] text-white py-16 font-sans border-t border-white/5">
    <div class="container mx-auto px-4 text-center">
        ...
        <div class="flex justify-center mb-6">
            <img src="images/l.png" alt="Lexvin Logo" class="h-34 w-auto object-contain">
        </div>
        ...
        <div class="flex justify-center gap-5 mb-12">
            <a href="https://instagram.com/lexvin.law" target="_blank" class="w-11 h-11 rounded-full bg-zinc-900/50 border hover:bg-[#B89B65] flex items-center justify-center hover:text-white hover:border-[#441424] hover:scale-110 transition-all duration-300 shadow-lg">
                <i class="fa-brands fa-instagram text-lg"></i>
            </a>
            <a href="mailto:lexvinlawfirm@gmail.com" class="w-11 h-11 rounded-full bg-zinc-900/50 border hover:bg-[#B89B65] flex items-center justify-center hover:text-white hover:border-[#441424] hover:scale-110 transition-all duration-300 shadow-lg">
