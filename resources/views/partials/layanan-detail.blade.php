...
<style>
    ...
    :root {
        ...
        /* Abu-abu terang (deskripsi) */
        --card-gradient-start: #451425;
        /* Marun Gelap (dari kode awal Anda) */
        --card-gradient-end: #1a080f;
        /* Hitam Marun (dari kode awal Anda) */
    ...
    .service-box {
        ...
        display: block;
        /* Memastikan tautan mengisi seluruh area */
        color: #ffffff;
        /* Memastikan warna teks default adalah putih */
    }
...
@section('content')
                    ...
                    <div class="service-detail-wrapper">
                        ...
                        <div class="service-content">
                            ...
                            <ul>
                                ...
                                <li><strong>Provide Legal Advice:</strong> Explain the client's legal position, rights, and
                                    obligations.</li>
                                <li><strong>Develop a Strategy:</strong> Provide recommendations on strategic steps to take,
                                    potential risks, and the most effective solutions.</li>
                            </ul>
    ...
    <a href="{{ route('layanan.detail', ['id' => 1]) }}" class="service-box">
        <i class="fas fa-users"></i> <h3>Litigation Support</h3>
