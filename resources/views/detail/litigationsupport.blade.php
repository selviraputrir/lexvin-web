 ...
 <nav class="hidden md:flex items-center space-x-8 text-sm font-serif ml-12 text-white whitespace-nowrap">
    ...
    <nav class="bg-[#D9D9D9] py-3 mt-4">
        <div class="container mx-auto px-6 text-black text-xs">
            ...
            <span class="opacity-60">  Litigation Support</span> / 
        ...
        <div class="flex flex-col lg:flex-row gap-16">
            ...
            <div class="lg:w-2/3">
                ...
                <div class="space-y-6 text-gray-300 leading-relaxed text-sm md:text-base">
                    <p>
                        When legal disputes cannot be resolved through negotiation, our litigation team stands ready to defend your rights in court. We handle civil, criminal, and commercial disputes with a strategic approach.
                    </p>

                    <p>We handle cases involving:</p>

                    <ul class="space-y-3 list-none">
                        <li class="flex gap-3">
                            <span class="text-[#B89B65] font-bold">*</span>
                            <span><strong>Commercial Disputes:</strong> Breach of contract, debt recovery, and shareholder disputes.</span>
                        </li>
                        <li class="flex gap-3">
                            <span class="text-[#B89B65] font-bold">*</span>
                            <span><strong>Employment Litigation:</strong> Defense against wrongful termination claims and labor law disputes.</span>
                        </li>
                        <li class="flex gap-3">
                            <span class="text-[#B89B65] font-bold">*</span>
                            <span><strong>Criminal Defense:</strong> Representation in white-collar crime allegations related to business entities.</span>
                        </li>
                        <li class="flex gap-3">
                            <span class="text-[#B89B65] font-bold">*</span>
                            <span><strong>Arbitration:</strong> Alternative dispute resolution to achieve efficient results outside of court.</span>
                        </li>
                    </ul>

                    <p>
                        Our goal is to achieve the best possible outcome while protecting your reputation and ensuring your long-term business stability.
                    </p>
                </div>
            </div>
